...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblWarning1.setText("La matrícula introducida no es válida, verifique sus datos.");
        getContentPane().add(lblWarning1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 290, 400, -1));
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ClientCorbaConection ccc = new ClientCorbaConection();
        if (!this.btnVerificar.getText().isEmpty()) {
            if (ccc.verificarMatricula(this.btnVerificar.getText())) {
                if (this.btnVerificar.getText() == "999") {
                    Resultados res = new Resultados();
                    res.show();
                    this.dispose();

                } else {
                    Boleta boleta = new Boleta(this.btnVerificar.getText());
                    boleta.show();
